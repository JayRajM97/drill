...
module.exports = {
  'position-notion-vs-confluence-google-docs': {
    ...
    chapters: [
      ...
      },
      {
        ...
        target: {"section": "Answer", "title": "Category"},
      ...
      },
      {
        ...
        target: {"section": "Answer", "title": "Alternatives"},
      ...
      {
        label: 'The statement',
        target: {"section": "Answer", "title": "Positioning Statement"},
      ...
      },
      {
        ...
        target: {"section": "Answer", "title": "Proof"},
  ...
  'q-zomato-buy-again-metrics': {
    ...
    chapters: [
      ...
      },
      {
        ...
        target: {"section": "Answer", "title": "Orders per active user"},
      ...
      },
      {
        ...
        target: {"section": "Answer", "title": "Metric tree"},
      ...
      },
      {
        ...
        target: {"section": "Answer", "title": "Measurement design"},
  ...
  'design-netflix-for-kids': {
    ...
    chapters: [
      ...
      {
        label: 'Prioritise',
        target: {"section": "Answer", "title": "Prioritization"},
      ...
      {
        label: 'The bet',
        target: {"section": "Answer", "title": "The Bet"},
      ...
      },
      {
        ...
        target: {"section": "Answer", "title": "Metrics"},
